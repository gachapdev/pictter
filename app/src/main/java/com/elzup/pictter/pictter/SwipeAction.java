...
public class SwipeAction implements View.OnTouchListener {
     ...
     */
    public SwipeAction(ListView listView, DismissCallbacks callbacks) {
     ...
     * to this listener. This will ensure that this {@link com.elzup.pictter.pictter.SwipeAction} is
     * paused during list view scrolling.</p>
     *
     * @see com.elzup.pictter.pictter.SwipeAction
     */
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        Log.d("ifAction", "sdfasdf");
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                if (mPaused) {
                    return false;
                }
                Log.d("ActionDOWN", "sdfasdf");
